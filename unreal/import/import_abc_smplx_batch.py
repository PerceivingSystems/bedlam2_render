...
#
# Notes:
# + Python for Windows: py -3 import_abc_smplx_batch.py 20 10
#
...
# Globals
IMPORT_SCRIPT_PATH = "C:/bedlam2/render/unreal/import/import_abc_smplx.py" # need forward slashes when calling via -ExecutePythonScript
...
def worker(unreal_app_path, unreal_project_path, import_script_path, batch_index, num_batches):
    # "C:\UE\UE_5.3\Engine\Binaries\Win64\UnrealEditor-Cmd.exe" "C:\UEProjects\5.3\BE_Import\BE_Import.uproject" -stdout -FullStdOutLogOutput -ExecutePythonScript="C:/bedlam2/render/unreal/import/import_abc_smplx.py 0 10" > log-0.txt
