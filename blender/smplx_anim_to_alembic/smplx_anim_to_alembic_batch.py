...
#
# Batch convert SMPL-X .npz animations to .abc with 2023 UV map
#
# Requirements:
#   + Blender 4.0.2+
...
if __name__ == "__main__":
    ...
    for input_path in filenames:
        ...
        if input_path.name.startswith("moyo"):
            output_path = output_dir / "moyo" / f"{input_path.stem}.abc"
        else:
            # it_4001_XL_2400.npz
            body_name = input_path.name.rsplit("_", maxsplit=1)[0]
            output_path = output_dir / body_name / f"{input_path.stem}.abc"
